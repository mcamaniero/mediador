...
<table width="406" height="190" border="0" align="center" cellpadding="2" cellspacing="2" class="tabla2">
  <tr class="style4">
    <td colspan="3" align="center">Eliminacion Masiva de Espacios en Intraway</td>
  </tr>
  <tr>
    <td width="106">&nbsp;</td>
    <td width="141">&nbsp;</td>
  ...
  <tr>
    ...
    <td>
    	...
    	<input name="pagina" id="pagina" type="hidden" value="eliminacioniw" />
  ...
  <br />
    ...
    <p>Eliminacion masiva: <a href="../doc/eliminaciones.txt">Instrucciones</a></p> 
    <p>Suspension masiva: <a href="../doc/suspensiones.txt">Instrucciones</a></p>
    </td>
  </tr>
</table>
    </form>
