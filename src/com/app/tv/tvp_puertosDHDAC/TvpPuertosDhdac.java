...
/**
 * TvpPuertosDhdac entity.
 * 
 * @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "tvp_puertosDHDAC", catalog = "aprovgrupotv", uniqueConstraints = {})
public class TvpPuertosDhdac implements java.io.Serializable {
	...
	/** default constructor */
	public TvpPuertosDhdac() {
	}

	/** full constructor */
	public TvpPuertosDhdac(Integer ciudad, Integer puertodesde,
