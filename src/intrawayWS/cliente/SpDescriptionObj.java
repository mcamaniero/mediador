...
public class SpDescriptionObj  implements java.io.Serializable {
    ...
    private intrawayWS.cliente.FlowsObj[] serviceFlowsUpstream;

    private intrawayWS.cliente.FlowsObj[] serviceFlowsDownstream;

    private intrawayWS.cliente.ComandosObj[] grupoComandosSNMP;

    private intrawayWS.cliente.OpcionesObj[] opcionesAdicionales;
    ...
    public SpDescriptionObj(
           ...
           intrawayWS.cliente.FlowsObj[] serviceFlowsUpstream,
           intrawayWS.cliente.FlowsObj[] serviceFlowsDownstream,
           intrawayWS.cliente.ComandosObj[] grupoComandosSNMP,
           intrawayWS.cliente.OpcionesObj[] opcionesAdicionales) {
     ...
     */
    public intrawayWS.cliente.FlowsObj[] getServiceFlowsUpstream() {
        return serviceFlowsUpstream;
    }
     ...
     */
    public void setServiceFlowsUpstream(intrawayWS.cliente.FlowsObj[] serviceFlowsUpstream) {
        this.serviceFlowsUpstream = serviceFlowsUpstream;
    }
     ...
     */
    public intrawayWS.cliente.FlowsObj[] getServiceFlowsDownstream() {
        return serviceFlowsDownstream;
    }
     ...
     */
    public void setServiceFlowsDownstream(intrawayWS.cliente.FlowsObj[] serviceFlowsDownstream) {
        this.serviceFlowsDownstream = serviceFlowsDownstream;
    }
     ...
     */
    public intrawayWS.cliente.ComandosObj[] getGrupoComandosSNMP() {
        return grupoComandosSNMP;
    }
     ...
     */
    public void setGrupoComandosSNMP(intrawayWS.cliente.ComandosObj[] grupoComandosSNMP) {
        this.grupoComandosSNMP = grupoComandosSNMP;
    }
     ...
     */
    public intrawayWS.cliente.OpcionesObj[] getOpcionesAdicionales() {
        return opcionesAdicionales;
    }
     ...
     */
    public void setOpcionesAdicionales(intrawayWS.cliente.OpcionesObj[] opcionesAdicionales) {
        this.opcionesAdicionales = opcionesAdicionales;
    }
